...
const EmptyRegionDialog = (props: Props): ReactElement => {
      ...
      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div className="text-center sm:mt-0">
          ...
          <h3 className="text-lg font-medium leading-6 text-gray-900">
            {formatMessage(transcriptionTabMessages.foundAnEmptyRegion)}
          </h3>
          <p className="text-sm text-gray-500 mb-2">
            {formatMessage(transcriptionTabMessages.willBeTranscripted)}
          </p>
        </div>
...
export default EmptyRegionDialog
