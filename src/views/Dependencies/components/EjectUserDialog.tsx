...
import { ejectUserMessages } from '../messages'
...
const EjectUserDialog = ({
  ...
  const getMessage = useFormatMessage(ejectUserMessages)
        ...
        <div className="sm:flex sm:items-start">
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h3 className="text-lg font-medium leading-6 text-gray-900">
              {getMessage('title', {
                user: <span className="italic">{userName}</span>,
                dependency: <span className="italic">{dependencyName}</span>
              })}
            </h3>
...
export default EjectUserDialog
